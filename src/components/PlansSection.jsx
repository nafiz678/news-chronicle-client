    ...
    return (
        <section className={`plans-section ${pathname === "/" ? "pt-24" : "pt-0"}  pb-10 `}>
            <div className="md:w-11/12 w-full flex flex-col items-center justify-center p-8 rounded-lg mx-auto text-center ">
                <h2 className={`lg:text-5xl md:text-4xl text-3xl text-start lg:text-center font-semibold ${pathname === "/" ? "text-gray-800" : "text-gray-300"} dark:text-white mb-8`}>Explore Our Premium Plans</h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-12">Choose the best plan to suit your needs. Get more with exclusive content, features, and support!</p>
                <div className="plans-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

                    {/* Plan 1 */}
                    <div className="bg-white dark:bg-transparent shadow-lg dark:shadow-none dark:border-2 rounded-xl p-5 flex flex-col items-start text-center transition-all transform hover:scale-105 hover:shadow-2xl hover:translate-y-2">
                        <div className='flex items-center mb-6 justify-between px-2 w-full'>
                            <h3 className="text-2xl text-wrap font-semibold text-gray-700 dark:text-gray-100">Beginner Plan</h3>
                            <div className="flex flex-col items-center">
                                <span className="text-2xl font-bold text-blue-600">04.99$ <span className='text-sm font-normal'>/mo</span> </span>
                            </div>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300 text-start ml-4 mb-6">Great for casual readers with limited access to articles.</p>

                        <ul className="text-start text-gray-600 dark:text-gray-300 mt-4 space-y-3 pl-5">
                    ...
                    {/* Plan 2 */}
                    <div className="bg-white dark:bg-transparent dark:shadow-none dark:border-2 shadow-lg rounded-xl p-5 flex flex-col items-start text-center transition-all transform hover:scale-105 hover:shadow-2xl hover:translate-y-2">
                        <div className='flex items-center mb-6 justify-between px-2 w-full'>
                            <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-100 ">Standard Plan</h3>
                            <div className="flex flex-col items-center ">
                                <span className="text-2xl font-bold text-green-600 ">$19.99 <span className='text-sm font-normal'>/mo</span></span>
                            </div>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300 text-start mb-6">For regular readers who want more access and features.</p>
                        <ul className="text-left text-gray-600 dark:text-gray-300 mt-4 space-y-3 pl-5">
                            <li className="flex items-center"><AiOutlineCheck className="inline text-green-500 mr-2" />No post limit</li>
                    ...
                    <div className="bg-white dark:bg-transparent dark:shadow-none dark:border-2 shadow-lg rounded-xl p-5 flex flex-col items-start text-center transition-all transform hover:scale-105 hover:shadow-2xl hover:translate-y-2">
                        <div className='flex items-center mb-6 justify-between px-2 w-full'>
                            <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-100 ">Premium Plan</h3>
                            <div className="flex flex-col items-center ">
                                <span className="text-2xl font-bold text-orange-600 ">$29.99 <span className='text-sm font-normal'>/mo</span></span>
                            </div>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300 text-start mb-6">For those seeking exclusive features and full support.</p>
                        <ul className="text-left text-gray-600 dark:text-gray-300 mt-4 space-y-3 pl-5">
